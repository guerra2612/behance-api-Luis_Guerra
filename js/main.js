...
$(document).ready(function() {
    ...
    // Get projects
    behanceAPI.getProjects("lguerra90", function(projectlist) {
        ...
        for(var i=0; i<projectlist.length; i++) {
            ...
            projectHTML += "<a href='#' class='col-lg-3 col-md-3 col-sm-4 col-xs-6' title='"+ project.name +"' onclick='loadProject(" + project.id + ")'><img class='coverimage' src='" + imgSrc + "' class='col-lg-4'></a>";
        }
